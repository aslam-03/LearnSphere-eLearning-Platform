...
const AdminDashboard = () => {
  ...
  const dashboardCards = [
    {
      ...
      description: 'View, create, and edit all courses in the platform',
      icon: (
    ...
    },
    {
      ...
      description: 'Add new instructor accounts to the platform',
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const handleCardClick = (route, comingSoon) => {
    if (comingSoon) {
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {dashboardCards.map((card, index) => (
              ...
              >
                <div className={`w-16 h-16 ${card.color} rounded-lg flex items-center justify-center text-white mb-4`}>
                  {card.icon}
                </div>
                ...
                <div className="mt-4">
                  <span className={`inline-flex items-center text-sm font-medium ${card.color.replace('bg-', 'text-')}`}>
